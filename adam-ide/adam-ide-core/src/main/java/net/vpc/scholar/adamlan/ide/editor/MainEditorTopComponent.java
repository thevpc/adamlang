 ...
 */
@ConvertAsProperties(
        dtd = "-//net.vpc.scholar.adam.adam.ide//MainEditor//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "net.vpc.scholar.adam.adam.ide.MainEditorTopComponent")
...
public final class MainEditorTopComponent extends TopComponent {
    ...
    public MainEditorTopComponent() {
        ...
        atmf.putMapping("text/adamlan", "net.vpc.scholar.adam.adam.ide.AdamLanTokenMaker");
