...
import net.vpc.scholar.adamlan.sybsystems.music.MusicContext;
import net.vpc.scholar.adamlan.sybsystems.music.MusicNote;
import net.vpc.scholar.adamlan.sybsystems.music.MusicNotes;
import net.vpc.scholar.adamlan.sybsystems.music.MusicParser;
...
//            }
    ...
    public void play(ExpressionEvaluator it, String... text) {
...
//        }
//    }
    public void play(ExpressionEvaluator it, MusicNotes... all) {
        if (all.length == 0) {
            return;
        }
        if (all.length == 1) {
