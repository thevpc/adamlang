 ...
 */
package net.thevpc.scholar.adamlan.commands.en;

import java.util.Locale;
import net.thevpc.scholar.adamlan.AbstractLangSupport;
import net.thevpc.scholar.adamlan.LangSupport;
import net.thevpc.scholar.adamlan.commands.fr.Assign_FR;
import net.thevpc.scholar.adamlan.commands.fr.Else_FR;
import net.thevpc.scholar.adamlan.commands.fr.End_FR;
import net.thevpc.scholar.adamlan.commands.fr.For_FR;
import net.thevpc.scholar.adamlan.commands.fr.If_FR;
import net.thevpc.scholar.adamlan.commands.fr.While_FR;
